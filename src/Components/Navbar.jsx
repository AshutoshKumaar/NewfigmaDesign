...
function Navbar() {
    return (
        <nav style={{ fontFamily: `'Josefin Sans', sans-serif` }} className='bg-[#fff] w-full h-24 px-2 md:px-20 flex flex-row justify-between items-center rounded-e-none md:rounded-t-[35px]' >
